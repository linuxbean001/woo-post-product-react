    ...
    render() {
        return (
         ...
         <div className='col-sm-8'>
           ...
           <span>
             <h5>
               { this.props.details[0].bedrooms} Bedrooms - { this.props.details[0].bathrooms}{' '}
               Bathrooms
             </h5>
           </span>
           <span> { this.props.details[0].address},</span><br></br>
           <span> { this.props.details[0].city},  { this.props.details[0].state}</span>
