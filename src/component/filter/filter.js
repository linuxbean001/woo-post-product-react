          ...
          <div className='container custom-container'>
            ...
            <div className='form-group'>
              ...
              >
                ...
                <TableHeaderColumn dataField='id' hidden={true} isKey>Product ID</TableHeaderColumn>
                <TableHeaderColumn dataField='address'>Address</TableHeaderColumn>
                <TableHeaderColumn dataField='city'>City</TableHeaderColumn>
                <TableHeaderColumn dataField='state'>State</TableHeaderColumn>
                <TableHeaderColumn dataField='building_name'>Building</TableHeaderColumn>
                <TableHeaderColumn dataField='price' dataFormat={this.priceFormatter}>Price</TableHeaderColumn>
                <TableHeaderColumn dataField='bedrooms'>BedRooms</TableHeaderColumn>
                <TableHeaderColumn dataField='bathrooms'>Bathrooms</TableHeaderColumn>
              </BootstrapTable>
            </div>
          </div>
        </main>
